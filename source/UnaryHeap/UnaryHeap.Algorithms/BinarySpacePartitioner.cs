...
namespace UnaryHeap.Algorithms
{
        ...
        where TPlane : IEquatable<TPlane>
    {
        ...
        protected BinarySpacePartitioner(IDimension dimension)
        {
            if (null == dimension)
    ...
    public abstract class Dimension2D<TSurface>
        : BinarySpacePartitioner<TSurface, Hyperplane2D, Orthotope2D, Facet2D>.IDimension
    {
        /// <summary>
        /// Gets the plane of a surface.
        /// </summary>
    ...
    public abstract class Dimension3D<TSurface>
        : BinarySpacePartitioner<TSurface, Hyperplane3D, Orthotope3D, Facet3D>.IDimension
    {
        /// <summary>
        /// Gets the plane of a surface.
        /// </summary>
