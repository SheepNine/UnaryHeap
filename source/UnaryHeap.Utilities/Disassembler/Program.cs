            ...
            using (var outputFile = File.CreateText("disassembly.txt"))
            {
                ...
                foreach (var output in new[] { TextWriter.Null, outputFile })
                {
                    ...
                    disassembler.Disassemble(0x08F6, ChrRomFileOffset(6, 0x8F6), 0x6F9, output, labels, new Range[] {
                        new DescribedRange(0x8F6, 0x77, "L1 Entity data", 7),
                        new DescribedRange(0x96D, 0x7E, "L2 Entity data", 7),
                        new DescribedRange(0x9EB, 0xA8, "L3 Entity data", 7),
                        new DescribedRange(0xA93, 0x9A, "L4 Entity data", 7),
                        new DescribedRange(0xB2D, 0xA1, "L5 Entity data", 7),
                        new DescribedRange(0xBCE, 0xA8, "L6 Entity data", 7),
                        new DescribedRange(0xC76, 0x93, "L7a Entity data", 7),
                        new DescribedRange(0xD09, 0x0E, "L8 Entity data", 7),
                        new DescribedRange(0xD17, 0x9A, "L9 Entity data", 7),
                        new DescribedRange(0xDB1, 0x70, "L10 Entity data", 7),
                        new DescribedRange(0xE21, 0x38, "L11 Entity data", 7),
                        new DescribedRange(0xE59, 0x31, "P1 Entity data", 7),
                        new DescribedRange(0xE8A, 0x3F, "P2 Entity data", 7),
                        new DescribedRange(0xEC9, 0x3F, "P3 Entity data", 7),
                        new DescribedRange(0xF08, 0x46, "P4 Entity data", 7),
                        new DescribedRange(0xF4E, 0x2A, "P5 Entity data", 7),
                        new DescribedRange(0xF78, 0x77, "L7b Entity data", 7),
                    });
                }
            }
