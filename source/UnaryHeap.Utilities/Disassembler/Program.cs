    ...
    class Program
    {
        ...
        private static void DisassemblePrgRom(Annotations annotations, OpcodeDisassembler disassembler, IDisassemblerOutput output)
        {
            var ranges = new Range[] {
                    ...
                    new DescribedRange(0xCCCF, 0x04, "Unkn 10/11 for pibblefish", 0x02),
                    new UnknownRange(0xCCD3, 0x04),
            ...
            var blocks = new[]
            {
                ...
                new DisassemblyBlock(0xD302, 0xD4AF, "EI_FLTT"),
                new DisassemblyBlock(0xD4B9, 0xD4DE, "EI_FLTT"),
                new DisassemblyBlock(0xD4E1, 0xD4F4, "EI_FLTT"),
                ...
                new DisassemblyBlock(0xB65A, 0xB6D2, "EI_SCAL"),
                ...
                new DisassemblyBlock(0x957F, 0x9610, "UNKN"),
                new DisassemblyBlock(0x9CDE, 0x9D54, "UNKN"),
                new DisassemblyBlock(0x9DA3, 0x9E0B, "UNKN"),
                new DisassemblyBlock(0x9E95, 0x9EA1, "UNKN"),
                new DisassemblyBlock(0x9F72, 0xAE8C, "UNKN"),
                new DisassemblyBlock(0xAEFF, 0xAF0A, "UNKN"),
                new DisassemblyBlock(0xB247, 0xB272, "UNKN"),
                new DisassemblyBlock(0xB315, 0xB58D, "UNKN"),
                new DisassemblyBlock(0xB6D2, 0xB6E5, "UNKN"),
                new DisassemblyBlock(0xB732, 0xB869, "UNKN"),
                new DisassemblyBlock(0xB8C5, 0xBA7F, "UNKN"),
                new DisassemblyBlock(0xBAC0, 0xBB14, "UNKN"),
                new DisassemblyBlock(0xBB85, 0xBDAF, "UNKN"),
                new DisassemblyBlock(0xBDED, 0xBE2F, "UNKN"),
                new DisassemblyBlock(0xBE83, 0xBE8E, "UNKN"),
                new DisassemblyBlock(0xBF3A, 0xBFB0, "UNKN"),
                new DisassemblyBlock(0xC03E, 0xC0B5, "UNKN"),
                new DisassemblyBlock(0xC2AA, 0xC350, "UNKN"),
                new DisassemblyBlock(0xC3A7, 0xC3BF, "UNKN"),
                new DisassemblyBlock(0xC3D7, 0xC587, "UNKN"),
                new DisassemblyBlock(0xC592, 0xC5B5, "UNKN"),
                new DisassemblyBlock(0xC62C, 0xC634, "UNKN"),
                new DisassemblyBlock(0xC64E, 0xC659, "UNKN"),
                new DisassemblyBlock(0xC78B, 0xCF63, "UNKN"),
                new DisassemblyBlock(0xD1D2, 0xD222, "UNKN"),
                new DisassemblyBlock(0xD245, 0xD26A, "UNKN"),
                new DisassemblyBlock(0xD279, 0xD2AA, "UNKN"),
                new DisassemblyBlock(0xD2C9, 0xD302, "UNKN"),
                new DisassemblyBlock(0xD4AF, 0xD4B9, "UNKN"),
                new DisassemblyBlock(0xD4F4, 0xD54A, "UNKN"),
