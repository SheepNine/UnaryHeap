    ...
    class Program
    {
        ...
        private static void DisassemblePrgRom(Annotations annotations, OpcodeDisassembler disassembler, IDisassemblerOutput output)
        {
            ...
            var blocks = new[]
            {
                ...
                new DisassemblyBlock(0xAE0F, 0xAE7F, "MSTATE"),
                ...
                new DisassemblyBlock(0xAE7F, 0xAE8C, "MSTATE"),
                ...
                new DisassemblyBlock(0x9186, 0x918B, "MSTATEP"),
                ...
                new DisassemblyBlock(0xC03E, 0xC048, "UNKN"),
