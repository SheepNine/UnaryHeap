...
namespace Disassembler
{
    class Comments
    {
        private Dictionary<int, string> comments = new Dictionary<int, string>()
        {
            ...
            { 0xE209, "Entity deletion methods" },
            { 0xE2C9, "Half-string render method (does one of two rows of tiles)" },
            { 0x8150, "Unknown subroutine" },
            { 0x817A, "Unknown subroutine (searching for an unused entity to populate?)" },
            { 0x8197, "Coordinate copying methods" },
            { 0xB848, "Unknown subroutine" },
            ...
            { 0x95FE, "Method for setting snake entity arrangement/attributes" },
            ...
            { 0xE161, "Unknown subroutine" },
            { 0xE17C, "Unknown subroutine" },
            { 0xE055, "Unknown subroutine" },
            { 0xE037, "Unknown subroutine" },
            { 0xD4D2, "Unknown subroutine" },
            { 0xDF1A, "Unknown subroutine" },
            { 0xD4E1, "Unknown subroutine" },
            { 0xD4F4, "Unknown subroutine" },
            { 0xD1D2, "Unknown subroutine" },
            { 0xCF40, "Unknown subroutine" },
            { 0xC64E, "Unknown subroutine" },
            { 0xB732, "Unknown subroutine" },
            { 0x866D, "Unknown subroutine" },
            { 0x8689, "Unknown subroutine" },
            { 0x9FB7, "Unknown subroutine" },
            { 0x9FC6, "Unknown subroutine" },
            { 0x9F9E, "Unknown subroutine" },
            { 0xA197, "Unknown subroutine" },
            { 0xAE7F, "Unknown subroutine" },
            { 0xB231, "Unknown subroutine" },
            ...
            { 0x8025, "Unknown subroutine" },
            { 0x899A, "Unknown subroutine" },
            { 0x89DA, "Method for 'blending in' entity attributes" },
            { 0x89E3, "Unknown subroutine" },
            { 0x89FD, "Unknown subroutine" },
            { 0x8A1A, "Unknown subroutine" },
            { 0x8A4E, "Unknown subroutine" },
            { 0x90C6, "Unknown subroutine" },
            { 0x9139, "Unknown subroutine" },
            { 0x9186, "Unknown subroutine" },
            { 0x918B, "Unknown subroutine" },
            { 0x9292, "Unknown subroutine" },
            { 0x92A2, "Unknown subroutine" },
            { 0x92BB, "Dynamic thunk" },
            { 0x92BE, "Unknown subroutine" },
            { 0x93B2, "Unknown subroutine" },
            { 0x9432, "Unknown subroutine" },
            { 0x9584, "Unknown subroutine" },
            { 0x9D45, "Unknown subroutine" },
            { 0x9D54, "Unknown subroutine" },
            { 0x9DA3, "Unknown subroutine" },
            { 0x9DC5, "Unknown subroutine" },
            { 0x9E95, "Unknown subroutine" },
            { 0xB3D7, "Unknown subroutine" },
            { 0xB527, "Unknown subroutine" },
            { 0xB7CD, "Unknown subroutine" },
            { 0xB869, "Method to spawn a new splash entity" },
            { 0xC2AA, "Unknown subroutine" },
            { 0xC3A7, "Unknown subroutine" },
            { 0xC476, "Unknown subroutine" },
            { 0xC552, "Unknown subroutine" },
            { 0xC8AC, "Unknown subroutine" },
            { 0xF51D, "Unknown subroutine" },
            { 0xFA31, "Unknown subroutine" },
            { 0xFCDE, "Unknown subroutine" },
            { 0x802F, "Entity creation method" },
            ...
            { 0xCD4C, "Unknown subroutine, many callers" },
            { 0xE237, "Unknown fragments" },
            { 0x86AA, "Thunk" },
            { 0xAFB9, "Thunk" },
            { 0xAFC6, "Thunk" },
            { 0x8010, "Thunks" },
            { 0xD2E1, "Wait for VBlank method" },
            { 0x8DB7, "Music looping method (if the track has ended)" },
            { 0xD62A, "Init music method" },
            { 0xD69A, "Some audio module method???" },
            { 0xD6FB, "Some audio module method???" },
            { 0xD8A1, "Some audio module method???" },
            { 0xD8D1, "Some audio module method???" },
            { 0xD99E, "Start of audio opcode methods" },

            { 0xFF80, "IRQ/BRK handler" },
            { 0xFF81, "NMI handler" },
            { 0xFFAE, "Busy wait method" },
            { 0xFFF1, "RST handler" },

            { 0xFFB5, "Mapper method A" },
            { 0xFFC9, "Mapper method B" },
            { 0xFFDD, "Mapper method C" },
            ...
            { 0xBAC0, "--------" },
            { 0xC8C7, "--------" },
            { 0x8666, "Fragment belonging to $8689 below" },
    ...
    class InlineComments
    {
        private Dictionary<int, string> comments = new Dictionary<int, string>()
        {
            ...
            { 0xB231, "NB: Y is greater than zero" },
            { 0x82F8, "Delete all entities except 0 and 1 (the snakes)" },
            { 0xCC46, "Transmute into a pibblyfish and tail-call into that AI" },
            { 0xBB8F, "NB: Function run twice, with Y=0 and Y=1, unless called remotely" },
            { 0xBF4E, "NB: Function run twice, with Y=0 and Y=1, unless called remotely" },
            ...
            { 0xB8B2, "Entity suicide if reached the end of the animation cycle" },
            ...
            { 0xB6FD, "Read animation arrangement for this frame" },
            ...
            { 0x8A18, "Unconditional branch" },
            { 0xAC3C, "Unconditional branch" },
