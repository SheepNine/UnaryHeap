    ...
    class OpcodeDisassembler : IDisposable
    {
        ...
        Instruction GetInstruction(byte opcode)
        {
            switch (opcode)
            {
                ...
                case 0xD0: return Branch.NE;
                case 0x90: return Branch.CC;
                case 0xF0: return Branch.EQ;
                case 0xB0: return Branch.CS;
                case 0x30: return Branch.MI;
                case 0x10: return Branch.PL;
                case 0x50: return Branch.VC;
                case 0x4C: return new RecognizedInstruction("JMP", new AbsoluteMode());
                case 0x20: return new RecognizedInstruction("JSR", new AbsoluteMode());
                case 0x6C: return new RecognizedInstruction("JMP", new IndirectMode());
