    ...
    class Annotations
    {
        ...
        public Annotations()
        {
            ...
            var loopBranches = new[] {
                ...
                0x81CA, 0x82FA, 0x836B, 0x8387, 0x8395, 0x842D, 0xE241,
                0xC402, 0xD643, 0xD6DE, 0xE2D5, 0xF530, 0xFBB9, 0xD284,
                0xFA33, 0xD247, 0xD26C, 0x818A, 0x9036, 0xE185,
                0x8155, 0x814B, 0x8219, 0xC659, 0xB41A, 0xB436, 0xBACE,
                0x8324, 0x83CF, 0x84F1, 0x84F3, 0x85EF, 0x85DC,
                0x85D3, 0x8632, 0x86D2, 0x8A08, 0x8DD3, 0x8DF9, 0x8E3B,
                0x8E63, 0x910B, 0xABF4, 0x85D1, 0x891D, 0xFED8,
                0x87FA, 0xFD8C, 0xFED9, 0xFF1E, 0xFF1D,
            };
            ...
            var skipBranches = new[] {
                ...
                0x810F, 0x8144, 0x81E1, 0x815E, 0xB8B5, 0xB382, 0xB262, 0x8984, 0xFF15,
                0xBB46, 0xBDED, 0x8546, 0x877C, 0x8E5B, 0x8E79, 0xB266, 0x8993, 0xFF2A,
                0x82B6, 0x82F2, 0x8379, 0x8361, 0x83A6, 0x83DE, 0xB7E3, 0x89FD, 0xFF2D,
                0x83F7, 0x8416, 0x841F, 0x8436, 0x8452, 0x8E9E, 0x87F4, 0xFD0A, 0xFF4F,
                0x9D1C, 0x9D76, 0x9D86, 0x9D95, 0x9D97, 0x9D99, 0x87FD, 0xFD15, 0xFF59,
                0x9D9F, 0x9E26, 0x833C, 0x85B2, 0x87DD, 0x8EB6, 0x8815, 0xFD2E, 0xFF5A,
                0xD564, 0xD578, 0xD5EF, 0xD6AA, 0xD6C8, 0xD6D8, 0x8824, 0xFD63, 0xFF22,
                0xD6E6, 0xD6EE, 0xD702, 0x85A7, 0x8EC3, 0x8605, 0x8840, 0xFD69,
                0xE2F5, 0xB753, 0xB6F4, 0xA037, 0xA043, 0xB3AF, 0x8850, 0xFD6F,
                0xB44A, 0xBE02, 0x834C, 0x857C, 0x8E39, 0x8EDD, 0x8865, 0xFD84,
                0xFBA6, 0xFBCA, 0xFBD3, 0xFBE2, 0xFCB5, 0xFF61, 0x8868, 0xFDAF,
                0xFFA6, 0xBE55, 0x853B, 0x8554, 0x87DB, 0x8EE0, 0x888C, 0xFDBA,
                0xBB85, 0xBBB2, 0xBBB5, 0xBC33, 0xBBF0, 0xBC04, 0x8896, 0xFDD9,
                0xBC1B, 0xBC23, 0xBC4C, 0xBC6F, 0x8C25, 0x8E13, 0x889E, 0xFDE9,
                0xBC6C, 0xBC83, 0xBC76, 0xBC7E, 0xBC9F, 0xBC9C, 0x88A0, 0xFE20,
                0xBCAE, 0xBCE3, 0xBC85, 0xBCA2, 0xBE2B, 0x90D1, 0x88A3, 0xFE46,
                0xBCF0, 0xBD58, 0xBD17, 0xBD34, 0xBD74, 0xB3CB, 0x88A6, 0xFE4B,
                0xB426, 0xBE5E, 0x8349, 0x855A, 0x8BDA, 0x90F4, 0x88C5, 0xFE4E,
                0xCB96, 0xC676, 0xC66D, 0xB8EC, 0xB70A, 0xB3C9, 0x88CF, 0xFE60,
                0xBB3E, 0xBE1B, 0x8393, 0x8572, 0x8C45, 0x9117, 0x88FC, 0xFE91,
                0xD4C4, 0xB74D, 0xB750, 0x9FFF, 0xA05B, 0xB40E, 0x8939, 0xFE96,
                0xBB2D, 0xBE0D, 0x82E8, 0x859E, 0x8C4A, 0x9183, 0x893C, 0xFEA3,
                0xE176, 0xE1C5, 0xE1EB, 0xE1FF, 0xB385, 0xB434, 0x8951, 0xFEC9,
                0xB5B1, 0xBB5A, 0x851D, 0x85AF, 0x8A3C, 0xAEAE, 0x8959, 0xFEDD,
                0xFA55, 0xFAB4, 0xFA71, 0xFA75, 0xFAD1, 0xFADF, 0x8963, 0xFEE5,
                0xFABF, 0xFBB7, 0xBFA2, 0x8593, 0x8A2B, 0xAF56, 0x896B, 0xFEE8,
                0x85BC, 0x8646, 0x864C, 0x8666, 0x86E2, 0x870A, 0x896F, 0xFF0A,
                0x8773, 0x8776, 0x89A8, 0x89BD, 0x89F5, 0xAF5E, 0x8982, 0xFF14,
            };
            ...
            var farBranches = new[]
            {
                ...
                0x8025, 0x8209, 0x84C2, 0x85FD, 0x8730, 0x88C2,
            };
