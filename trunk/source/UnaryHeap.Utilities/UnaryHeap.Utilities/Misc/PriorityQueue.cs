...
namespace UnaryHeap.Utilities.Misc
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage(
        ...
        Justification = "'Priority queue' is a well-known computer science concept.")]
    public class PriorityQueue<T>
    {
        ...
        /// </summary>
        /// <param name="item">The object to be added to the PriorityQueue.
        ...
        /// The PriorityQueue contains no elements.</exception>
        public T Dequeue()
        {
            var result = Peek();
        ...
        void SiftDown(int index)
        {
            ...
            while (true)
            {
                ...
                {
                    if (comparer.Compare(heap[leftChild], heap[rightChild]) <= 0 &&
                        comparer.Compare(heap[leftChild], heap[i]) <= 0)
                    {
